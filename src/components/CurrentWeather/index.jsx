              ...
              <div className="weather__inner">
                <div className="weather__section">
                  ...
                  <div className="weather__value">
                    <span id="wind">{weather.wind.speed}</span> km/h</div>
                </div>
                <div className="weather__section">
                  <h3 className="weather__title">Humidity</h3>
                  <div className="weather__value">
                    <span id="humidity">{weather.main.humidity}</span> %</div>
                </div>
              </div>
              <div className="weather__inner">
                <div className="weather__section">
                  ...
                  <div className="weather__value">
                    <span id="sunrise">{convertTime(String(weather.sys.sunrise))}</span>
                  </div>
                </div>
                <div className="weather__section">
                  <h3 className="weather__title">Sunset</h3>
                  <div className="weather__value">
                    <span id="sunset">{convertTime(String(weather.sys.sunset))}</span>
                  </div>
                </div>
              </div>
            </div> 
